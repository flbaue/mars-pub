...
public class DefaultAdListTest {
    ...
    public void sortedTest() {
        ...
        assertTrue(liste.isSorted());

        liste.add(2);

        assertFalse(liste.isSorted());
...
//
//
//        ((DefaultAdList) liste).resetCounter();
//
//        start = System.currentTimeMillis();
//        liste.recInsert(10, 0);
//        end = System.currentTimeMillis();
//        System.out.println("recInsert Pos=0 \tTicks=" + ((DefaultAdList) liste).getSteps() + " \tTime=" + (end - start));
...
//        end = System.currentTimeMillis();
//        System.out.println("recInsert Pos=" + pos + " \tTicks=" + ((DefaultAdList) liste).getSteps() + " \tTime=" + (end - start));
...
//        liste.insert(100, 0);
//        end = System.currentTimeMillis();
//        System.out.println("insert Pos=0 \tTicks=" + ((DefaultAdList) liste).getSteps() + " \tTime=" + (end - start));
...
//        end = System.currentTimeMillis();
//        System.out.println("insert Pos=" + pos + " \tTicks=" + ((DefaultAdList) liste).getSteps() + " \tTime=" + (end - start));
